...
01. WPSSO RRSSB example showing **Ridiculously Responsive Social Sharing Buttons** enabled (with the default stylesheet) in the CSS sidebar, content text, and widget.
