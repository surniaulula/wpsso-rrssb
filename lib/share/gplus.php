...
if ( ! class_exists( 'WpssoRrssbSubmenuShareGplus' ) ) {

	class WpssoRrssbSubmenuShareGplus {
		...
		public function __construct( &$plugin ) {
			...
			$this->p->util->add_plugin_filters( $this, array(
				'rrssb_share_gplus_rows' => 3,
			) );
		}

		public function filter_rrssb_share_gplus_rows( $table_rows, $form, $submenu ) {
			...
			$table_rows[] = $form->get_tr_hide( 'basic', 'gp_rrssb_html' ).
			'<td colspan="2">'.$form->get_textarea( 'gp_rrssb_html', 'button_html code' ).'</td>';
...
if ( ! class_exists( 'WpssoRrssbShareGplus' ) ) {

	class WpssoRrssbShareGplus {
