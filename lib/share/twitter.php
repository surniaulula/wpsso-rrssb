...
if ( ! class_exists( 'WpssoRrssbShareTwitter' ) ) {
	...
	<a href="https://twitter.com/intent/tweet?original_referer=%%sharing_url%%&url=%%sharing_short_url%%&text=%%twitter_text%%&hashtags=%%twitter_hashtags%%&via=%%twitter_via%%&related=%%twitter_related%%" class="popup">
