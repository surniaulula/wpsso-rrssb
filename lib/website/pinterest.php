...
if ( ! class_exists( 'WpssoRrssbSharingPinterest' ) ) {
	...
	<a href="http://pinterest.com/pin/create/button/?url=%%sharing_url%%&amp;media=%%media_url%%&amp;description=%%pinterest_summary%%" class="popup">
		...
		public function get_html( $atts = array(), &$opts = array() ) {
			...
			return $this->p->util->replace_inline_vars( $this->p->options['pin_html'], $use_post, false, $atts, array(
					'media_url' => rawurlencode( $atts['photo'] ),
				 	'pinterest_summary' => rawurlencode( $this->p->webpage->get_caption( 'excerpt', $opts['pin_cap_len'],
