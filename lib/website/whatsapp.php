...
if ( ! class_exists( 'WpssoRrssbSubmenuSharingWhatsApp' ) && class_exists( 'WpssoRrssbSubmenuSharingButtons' ) ) {

	class WpssoRrssbSubmenuSharingWhatsApp extends WpssoRrssbSubmenuSharingButtons {
		...
		protected function get_rows( $metabox, $key ) {
			...
			$rows[] = '<tr class="hide_in_basic">'.
			'<td colspan="2">'.$this->form->get_textarea( 'wa_rrssb_html', 'average code' ).'</td>';
...
if ( ! class_exists( 'WpssoRrssbSharingWhatsApp' ) ) {

	class WpssoRrssbSharingWhatsApp {
