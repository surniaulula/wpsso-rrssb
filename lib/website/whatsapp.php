...
if ( ! class_exists( 'WpssoRrssbSubmenuWebsiteWhatsApp' ) ) {
	...
	class WpssoRrssbSubmenuWebsiteWhatsApp {
		...
		public function __construct( &$plugin ) {
			...
			$this->p->util->add_plugin_filters( $this, array(
				'rrssb_website_whatsapp_rows' => 3,	// $table_rows, $form, $submenu
			) );
		}

		public function filter_rrssb_website_whatsapp_rows( $table_rows, $form, $submenu ) {
...
if ( ! class_exists( 'WpssoRrssbWebsiteWhatsApp' ) ) {
